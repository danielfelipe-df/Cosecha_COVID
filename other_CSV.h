...
void csv_ws(std::vector<std::vector<std::wstring> > &w, std::string archivo, wchar_t wc = L'\t');

//Lee el archivo CSV y los retorna en una matriz de long long
void csv_ll(std::vector<std::vector<long long> > &w, std::string archivo, wchar_t wc = L'\t');

//Lee el archivo CSV y los retorna en una matriz de double
void csv_d(std::vector<std::vector<double> > &w, std::string archivo, wchar_t wc = L'\t');


//Lee el archivo CSV y los retorna en una matriz de int
void csv_i(std::vector<std::vector<int> > &w, std::string archivo, wchar_t wc = L'\t');


//Lee el archivo CSV y los retorna en una matriz de float
void csv_f(std::vector<std::vector<float> > &w, std::string archivo, wchar_t wc = L'\t');
...
//Además, retorna todos los caracteres en mayúscula.
void csv_ws_without_spaces(std::vector<std::vector<std::wstring> > &w, std::string archivo, wchar_t wc = L'\t');
